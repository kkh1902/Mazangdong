...
class _DirectState extends State<DirectPage> {
  NaverMapController? _controller;
  String startLocation = "현재위치";
  String goalLocation = "마포역";
  String startTime = "오늘 3시 10분 출발";
  ...
  void fetchCoordinates() async {
    ...
    if (position != null) {
...

      {
        ...
        "origin": [37.5455, 126.9528],
        "destination": [37.540038, 126.946297], //마포역
        "type": 1
      };
  ...
  void getCurrentLocation() async {
    ...
    if (position != null) {
      ...
      final target = LatLng(37.5455,126.9528);
