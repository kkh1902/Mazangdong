...
class SelectBusPage extends StatefulWidget {
  ...
  @override
  _SelectBusPagePageState createState() =>
      _SelectBusPagePageState();
}

class _SelectBusPagePageState extends State<SelectBusPage> {
  ...
  void goToNextPage() {
    ...
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => SelectConvPage(convModel: widget.convModel),
      ),
    );
  }
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(
              height: 200,
              width: 200,
              child: Image.asset('assets/images/icons/bus.png'),
            ),
            SizedBox(height: 30),
            Column(
              children: [
